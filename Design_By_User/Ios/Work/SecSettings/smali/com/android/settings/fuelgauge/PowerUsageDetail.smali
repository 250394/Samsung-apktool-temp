...
.method static constructor <clinit>()V
    ...
    :array_0
    .array-data 0x4
        0x43t 0x6t 0x9t 0x7ft
        0x44t 0x6t 0x9t 0x7ft
        0x42t 0x6t 0x9t 0x7ft
        0x48t 0x6t 0x9t 0x7ft
        0x4at 0x6t 0x9t 0x7ft
        0x46t 0x6t 0x9t 0x7ft
        0x4dt 0x6t 0x9t 0x7ft
    .end array-data
.end method
...
.method public onActivityCreated(Landroid/os/Bundle;)V
    ...
    .line 152
    iget-object v0, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mControlsParent:Landroid/view/ViewGroup;
...
.method public onKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    sget-object v3, Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;->SCREEN:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDrainType:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    sget-object v3, Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;->WIFI:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDrainType:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    sget-object v3, Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;->BLUETOOTH:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDrainType:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    sget-object v3, Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;->CELL:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    if-eq v2, v3, :cond_0

    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mDrainType:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    sget-object v3, Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;->APP:Lcom/android/settings/fuelgauge/PowerUsageDetail$DrainType;

    if-ne v2, v3, :cond_1

    iget-boolean v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mUsesGps:Z

    if-eqz v2, :cond_1

    .line 548
    :cond_0
    iget-object v2, p0, Lcom/android/settings/fuelgauge/PowerUsageDetail;->mActionButton:Landroid/widget/Button;

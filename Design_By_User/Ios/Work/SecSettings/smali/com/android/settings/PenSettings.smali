.class public Lcom/android/settings/PenSettings;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/PenSettings;->PEN_NOTIFICATION_SOUND0:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/PenSettings;->packagelist:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/PenSettings;->mPenNotificationList:Ljava/util/ArrayList;
    ...
    sput-object v0, Lcom/android/settings/PenSettings;->mPenNotificationListValues:Ljava/util/ArrayList;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/PenSettings;->mPenApplicationEntries:Ljava/util/Vector;
    ...
    iput-object v0, p0, Lcom/android/settings/PenSettings;->mPenApplicationValues:Ljava/util/Vector;
...
.method private makePenNotificationList()V
    ...
    .prologue
    .line 213
    sget-object v0, Lcom/android/settings/PenSettings;->mPenNotificationList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0}, Lcom/android/settings/PenSettings;->getResources()Landroid/content/res/Resources;
    ...
    .line 219
    sget-object v0, Lcom/android/settings/PenSettings;->mPenNotificationListValues:Ljava/util/ArrayList;
    ...
    sget-object v1, Lcom/android/settings/PenSettings;->PEN_NOTIFICATION_SOUND0:Ljava/lang/String;
...
.method private setPenApplicationEntriesAndValues()V
    ...
    .local v2, i:I
    :goto_0
    sget-object v8, Lcom/android/settings/PenSettings;->packagelist:[Ljava/lang/String;
    ...
    .line 190
    :try_start_0
    invoke-virtual {p0}, Lcom/android/settings/PenSettings;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iget-object v8, p0, Lcom/android/settings/PenSettings;->mPenApplicationEntries:Ljava/util/Vector;

    invoke-virtual {v8, v0}, Ljava/util/Vector;->add(Ljava/lang/Object;)Z

    .line 194
    iget-object v8, p0, Lcom/android/settings/PenSettings;->mPenApplicationValues:Ljava/util/Vector;
...
.method private updateDetachNotiPref()V
    ...
    .prologue
    .line 227
    invoke-virtual {p0}, Lcom/android/settings/PenSettings;->getContentResolver()Landroid/content/ContentResolver;
    ...
    .line 233
    :cond_0
    iget-object v3, p0, Lcom/android/settings/PenSettings;->mDetachNoti:Landroid/preference/Preference;
...
.method private updatePenApplicationPref()V
    ...
    .prologue
    .line 238
    iget-object v4, p0, Lcom/android/settings/PenSettings;->mPenApplication:Landroid/preference/ListPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 113
    invoke-virtual {p0}, Lcom/android/settings/PenSettings;->getActivity()Landroid/app/Activity;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/PenSettings;->addPreferencesFromResource(I)V

    .line 117
    const-string v1, "pen_hovering"

    invoke-virtual {p0, v1}, Lcom/android/settings/PenSettings;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v1

    check-cast v1, Landroid/preference/CheckBoxPreference;

    iput-object v1, p0, Lcom/android/settings/PenSettings;->mPenHovering:Landroid/preference/CheckBoxPreference;

    .line 118
    iget-object v4, p0, Lcom/android/settings/PenSettings;->mPenHovering:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v1, p0, Lcom/android/settings/PenSettings;->mDetachNoti:Landroid/preference/Preference;

    .line 121
    invoke-direct {p0}, Lcom/android/settings/PenSettings;->makePenNotificationList()V
    ...
    iput-object v1, p0, Lcom/android/settings/PenSettings;->mDetachMode:Landroid/preference/CheckBoxPreference;

    .line 124
    iget-object v1, p0, Lcom/android/settings/PenSettings;->mDetachMode:Landroid/preference/CheckBoxPreference;
    ...
    .line 127
    invoke-direct {p0}, Lcom/android/settings/PenSettings;->setPenApplicationEntriesAndValues()V
    ...
    iput-object v1, p0, Lcom/android/settings/PenSettings;->mPenApplication:Landroid/preference/ListPreference;

    .line 129
    iget-object v2, p0, Lcom/android/settings/PenSettings;->mPenApplication:Landroid/preference/ListPreference;

    iget-object v1, p0, Lcom/android/settings/PenSettings;->mPenApplicationEntries:Ljava/util/Vector;

    iget-object v3, p0, Lcom/android/settings/PenSettings;->mPenApplicationEntries:Ljava/util/Vector;
    ...
    iget-object v1, p0, Lcom/android/settings/PenSettings;->mPenApplicationValues:Ljava/util/Vector;

    iget-object v3, p0, Lcom/android/settings/PenSettings;->mPenApplicationValues:Ljava/util/Vector;
    ...
    .line 131
    iget-object v1, p0, Lcom/android/settings/PenSettings;->mPenApplication:Landroid/preference/ListPreference;
    ...
    .line 132
    invoke-direct {p0}, Lcom/android/settings/PenSettings;->updatePenApplicationPref()V
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    .line 171
    iget-object v3, p0, Lcom/android/settings/PenSettings;->mPenApplication:Landroid/preference/ListPreference;
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 151
    iget-object v3, p0, Lcom/android/settings/PenSettings;->mPenHovering:Landroid/preference/CheckBoxPreference;
    ...
    .end local v0           #value:Z
    :cond_2
    iget-object v3, p0, Lcom/android/settings/PenSettings;->mDetachMode:Landroid/preference/CheckBoxPreference;
...
.method public onResume()V
    ...
    .line 141
    invoke-direct {p0}, Lcom/android/settings/PenSettings;->updateDetachNotiPref()V
